...
import { Item as ItemType } from 'components/pages/account/Notifications/components/FeatureOne/types';
import Item from 'components/pages/account/Notifications/components/FeatureOne/components/Item';
